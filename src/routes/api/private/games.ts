...
import ResourcePermissionError from '../../../resources/errors/ResourcePermissionError'
...
module.exports = class {
    ...
    setupApplication(){
        this.app.get("/",(req, res)=>{
            ...
            //Get Games
            throw new ResourcePermissionError()
        })
        ...
        this.app.use((error:APIError,req:express.Request,res:express.Response,next:express.NextFunction)=>{
